...
export function humanMatchLabel(matchId: string, tr: Translate = germanFallback): string {
...
export function groupAdvanceSlots(groupCount: number, advancePerGroup: number): BracketSlot[] {
