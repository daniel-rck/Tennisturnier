...
export const en: Record<TranslationKey, string> = {
  ...
  'onboarding.welcome.body': 'Schedule, round timer, score entry and award ceremony — all in your browser, no sign-up.',
  'onboarding.formats.title': 'Four tournament formats',
  'onboarding.formats.body': 'Rotation (Mixed/Women/Men/Open), groups, knockout, or groups + knockout. Pick the format on the setup page.',
  'onboarding.privacy.title': 'Your data stays here',
  'onboarding.privacy.body': "Stored locally in your browser — nothing leaves your device. Optional: live-sync via code between devices, e.g. enter on phone, display on TV.",
  'onboarding.start.title': 'Ready?',
  'onboarding.start.body': 'Add players or teams, generate the schedule and enter results. The award ceremony is computed automatically.',
  ...
  'setup.formatHint.rotation': 'Rotation tournament with rotating mixed doubles. Every round fills all courts.',
  'setup.formatHint.groups': 'Group stage with round-robin in each group. Standings per group.',
  'setup.formatHint.knockout': 'Knockout from round 1. Bracket with byes if the participant count is not a power of 2.',
  'setup.formatHint.groups-ko': 'Group stage + final knockout. The top N per group advance to the bracket.',
  ...
  'setup.partialFinalHint': 'Surplus rounds are dropped if everyone has already played the same amount.',
  'setup.perGenderRanking': 'Also show separate rankings for women and men',
  'setup.perGenderRankingHint': 'In the ranking view, separate tables per gender appear next to the overall ranking.',
  ...
  'players.empty.description': 'Type a name above and pick Woman/Man — then "Add". Drag-and-drop to reorder.',
  'players.empty.action': 'Add the first player',
  'players.removeConfirm.title': 'Remove "{name}"?',

  // Entries
  'entries.descDoubles': 'Add fixed doubles pairs. Order = seeding (1st = strongest team), reorderable via drag-and-drop.',
  ...
  'entries.empty.description': 'Enter the names above and click "Add". Drag-and-drop to change the seeding order.',
  ...
  'groups.empty.description': 'Add participants on the Teams page first — groups will form automatically.',
  ...
  'bracket.empty.descriptionKo': 'Add at least 2 participants on the Teams page — the bracket will be generated automatically.',
  'bracket.empty.descriptionGroupsKo': 'Add participants first. The knockout bracket appears once the group stage is finished.',
  ...
  'ranking.empty.entriesDescription': 'Add participants on the Teams page — group standings appear automatically.',
  ...
  'ranking.finalPending': '🎯 Final not decided yet — the ceremony is waiting for the last results.',
  ...
  'print.empty.description': 'Generate a schedule, group stage or bracket first — the printable layout appears here.',
  ...
  'sync.intro': 'Share your tournament across multiple devices — e.g. enter on phone, display on TV. Data lives in Cloudflare KV for 7 days, then is deleted.',
  ...
  'sync.ownerTokenHint': 'Stored on this device. If lost, no one can write — create a new code in that case.',
  ...
  // Offline banner
  'offline.message': 'Offline — changes are stored locally and will sync when the connection returns.',

  // Privacy dialog
  'privacy.title': 'Privacy policy',
  'privacy.intro': 'The Tennis Tournament Planner is a pure web/PWA app. We process as little data as possible and store, by default, exclusively on your device.',
  'privacy.h.local': '1. Local browser storage',
  'privacy.p.local': 'Tournament data (players, schedule, results, settings) and your theme choice are stored in your browser localStorage. This data does not leave your device unless you enable live-sync. You can clear it any time via your browser settings.',
  'privacy.h.sync': '2. Optional live-sync (opt-in)',
  'privacy.p.sync': 'When you enable live-sync, the current tournament is uploaded to a Cloudflare KV store and made available under a 6-character share code. Other devices can read or mirror the tournament with this code.',
  'privacy.li.sync1': 'Only tournament data is transmitted – no personal account or contact data.',
  'privacy.li.sync2': 'Player names you enter are part of the tournament data and are transmitted with it.',
  'privacy.li.sync3': 'The data is auto-deleted 7 days after the last change (KV TTL). When the owner leaves a sync session, the entry is discarded immediately.',
  'privacy.li.sync4': 'No sign-up, no tracking, no cookies, no analytics.',
  'privacy.h.hosting': '3. Hosting',
  'privacy.p.hosting': 'The app is served via Cloudflare Workers. When you visit the site, Cloudflare processes technically necessary connection data (e.g. IP address, user-agent, timestamp) to provide and secure the service. We do not analyze or persistently store this data.',
  'privacy.h.external': '4. External resources',
  'privacy.p.external': 'The app does not load external fonts, scripts or trackers. Only your device system fonts and the assets shipped with the app are used.',
  'privacy.h.pwa': '5. PWA / service worker',
  'privacy.p.pwa': 'For offline support the app uses a service worker that stores program code and assets in the browser cache. No personal data is collected in the process.',
  'privacy.h.rights': '6. Your rights',
  'privacy.p.rights': 'Since we do not store personal data on the server side (other than the tournament data you voluntarily upload via sync, which auto-expires after 7 days), no extended right of access, correction or deletion is usually required. You can remove local data via your browser settings; you can stop active sync sessions inside the app.',
  ...
  'statistics.empty.description': 'Enter results in the previous tabs — statistics are computed automatically.',
  ...
  'statistics.legend.bestPartner': 'Best partner = most-frequent winning partner (wins/shared matches)',
  'statistics.legend.bestOpponent': 'Easiest opponent = most-defeated opponent (wins/matches against)',
}
